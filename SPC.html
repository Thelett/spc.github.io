...
<BODY>
    <div class="sp-container">
        <div class="sp-content">
            ...
            <h2 class="frame-1">Gửi SPCers</h2>
            <h2 class="frame-2">Những chúa tể học thức</h2>
            <h2 class="frame-3">Hãy chiến hết mình</h2>
            <h2 class="frame-4">Bất bại trong kì thi</h2>
            <h2 class="frame-5">
                <span>From</span>
                <span>SPC</span>
                <span>with love</span>
